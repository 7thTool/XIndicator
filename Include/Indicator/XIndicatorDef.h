#ifndef _H_XINDICATORDEF_H_
#define _H_XINDICATORDEF_H_
...
enum INDICATOR_STYLE
{
	...
	INDICATOR_STYLE_DRAWLINE	= 0X04,			//画线指标
};
...
#define INDICATOR_PERIOD_HOUR		60*60
#define INDICATOR_PERIOD_4HOUR		60*60*4
...
enum 
{
	MODE_NONE = 0, //无
	MODE_ORDERS, //委托
	MODE_HISTORY_ORDERS, //历史委托
	MODE_TRADES, //成交
	MODE_HISTORY_TRADES, //历史成交
	MODE_POSITION, //持仓
};
